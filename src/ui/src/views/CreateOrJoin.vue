<template>
    <div class="modal-overlay" @click.self="closeModal">
        <div
            ...
            <!-- Кнопка создания нового сервера -->
            ...
            <div class="grid w-full gap-2">
                ...
                <Input id="invite-code" v-model="inviteCode"  placeholder="e.g., ABCD-1234" />
...
const inviteCode = ref(''); // Поле для инвайт-кода

// Закрытие модального окна
const closeModal = () => {
    alert('Modal closed');
    // Здесь вы можете добавить логику закрытия окна
};
...
const joinServer = () => {
    ...
    alert(`Joined server with invite code: ${inviteCode.value}`);
    inviteCode.value = ''; // Очистка поля
    closeModal();
};

// Логика для создания нового сервера
const createServer = () => {
