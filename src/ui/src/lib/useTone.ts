...
const customAudioContext = new AudioContext({ sampleRate: 48000, latencyHint: 'playback' });
...
function playCallSound() {
    ...
    const basePattern = new Tone.Part((time) => {
...
export { playSoftLeaveSound, playSoftEnterSound, playCallSound, playMuteAllSound, playUnmuteAllSound }