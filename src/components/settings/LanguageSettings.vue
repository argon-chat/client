...
const allLang = [
  {
    ...
    code: "en",
    emoji:
      '<i class="em em-flag-um" aria-role="presentation" aria-label="U.S. Outlying Islands Flag"></i>',
  },
  {
    key: "Пирацкий",
    code: "ru_pt",
    emoji:
      '<i class="em em-pirate_flag" aria-role="presentation" aria-label=""></i>',
  },
  {
    key: "日本語",
    code: "jp",
