            ...
            <form @submit.prevent="onSubmit" class="flex flex-col h-full">
                ...
                <CardContent class="flex flex-col gap-4 pt-6">
                    <div class="flex justify-center">
                        <PinInput id="reset-code" class="justify-center" v-model="model" placeholder="○"
                    ...
                    <div class="flex flex-col gap-2">
                        <Label for="password" class="text-gray-300">New Password *</Label>
                        <Input id="password" v-model="password" type="password" :disabled="isLoading"
                            class="bg-zinc-900 border border-zinc-700 text-white placeholder-gray-500"
