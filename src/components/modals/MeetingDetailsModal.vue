<template>
  <Dialog v-model:open="open">
    <DialogContent
      class="sm:max-w-[500px] rounded-2xl border bg-card/95 backdrop-blur-2xl p-8 space-y-6"
    >
      <div
      ...
      <div class="relative space-y-4">
        ...
        <div class="space-y-2">
          ...
          <div class="relative">
            <Input
              :model-value="meetingInfo?.meetingCode || ''"
              readonly
        ...
        <div class="space-y-2">
          ...
          <div class="flex gap-2">
            <Input
              :model-value="meetingInfo?.meetingUrl || ''"
              readonly
              class="flex-1"
            />
            <Button
