...
function select(tab: "dashboard" | "friends" | "notifications" | "inventory" | "overlayDebug") {
  router.push({ path: `/master.pg/home/${tab}` });
  tabRef.value = tab;
}
const tabRef = ref("dashboard" as "dashboard" | "friends" | "notifications" | "inventory" | "overlayDebug");
