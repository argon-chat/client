...
import type { DTMFPlayer } from "@argon/audio";

const isActive = ref(false);
const pressed = ref(new Set<string>());

// Inject DTMF player from parent or use provided prop
const injectedDTMF = inject<DTMFPlayer | null>('dtmfPlayer', null);
...
const dtmf = computed(() => props.dtmfPlayer ?? injectedDTMF);
